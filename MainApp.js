...
var addSiteAccountMFA = require(path.resolve('aggregation/AddSiteAccountMFA.js'));
var request = require('request');
var readlineSync = require('readline-sync');
var async = require('async');

//Setting input parameters for cobrand login API call
globalApp.properties.options.url = configApp.properties.baseURL + globalApp.properties.cobrandLoginURL;
...
request(
    ...
    function (error, response, body) {
        ...
        if (!error && response.statusCode == 200) {
            ...
            globalApp.properties.options.method = globalApp.properties.post;
            globalApp.properties.headers.Authorization = 'cobSession=' + globalApp.properties.cobSessionToken;
            ...
            request(
                ...
                function (error, response, body) {
                    ...
                    if (error) {
                        return console.log('Error in User login: ', error);
                    }
                    if (!error && response.statusCode == 200) {
